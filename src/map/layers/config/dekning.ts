...
export const dekningConfig: ThemeLayerConfig = {
  categories: [
    {
      id: 'dekning',
      groupid: 18,
  ...
  layers: [
    ...
    },
    {
      ...
      type: 'geojson',
      geojsonUrl: '/json/dekning/land/n50/n50_pod_inndeling2025.json',
