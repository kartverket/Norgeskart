...
import { Payload, pollPdfStatus, requestPdfGeneration } from '../../api/printApi';
                    ...
                    layers: [
                        {
                            ...
                            matrices: [ //husk å ta ut disse i en egen
                                {
                                    identifier: '0',
...
/*    // Nå kan du bruke layerInfo og backgroundLayer direkte
   console.log('Aktivt bakgrunnslag:', backgroundLayer);
   console.log('Laginfo:', layerInfo);
   // ...resten av PDF-genereringen...
}; */