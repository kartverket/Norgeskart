...
// Layers grouped under their WMS so users see which ones belong together. The
// whole-service entry becomes the group's own add action — looked up in all
// data, since a search for "Dam" doesn't match the entry titled "Vannkraft WMS".
            ...
            if (single) {
              ...
              return (
                <ResultRow
                  key={group.url}
                  title={entry.title}
                  subtitle={group.service.organization}
